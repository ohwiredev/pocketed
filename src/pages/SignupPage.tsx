                ...
                <div className="p-6">
                    <div>
                        <Link
                            to="/"
                            aria-label="go home">
                            <img src={trademark} alt="Pocketed Logo" className="h-15 w-auto" />
                        </Link>
                        <h1 className="mt-6 text-balance text-xl font-semibold">
                            <span className="text-muted-foreground">Welcome to Pockted!</span> Create an Account to Get Started
                        </h1>
                    </div>
